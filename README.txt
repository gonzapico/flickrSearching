...
To run the app you only have to compile the project on Android Studio and run it on your device. Anyway the latest generated apk file in on the generated folder, so you can copy and install on your app with the adb.
